...
\makecvtitle
  ...
  \vspace{-0.15in}
  \section{EXPERIENCE} 
  \cventry{2022--Present}{Systems Engineer}{Backbone Labs Inc.}{Atherton, CA}{}{
    \begin{itemize}
      \item Defined, developed, and managed next-generation firmware
            architecture for Backbone Pro (9/10 IGN). Managed firmware design
            and development, delivering $>= 1$ FW release per week for rapid
            deployment and testing in 12 month development cycle.
      ...
      \item Developing next-generation electronics and software architectures
            for cross-platform gaming experiences including BLE, WiFi, NFC,
            ESP-NOW (802.11), and WiFi Direct.
